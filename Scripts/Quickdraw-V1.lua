...
local AimbotTab = Window:CreateTab("Aimbot", 6031154871)
...
local CrosshairTab = Window:CreateTab("Crosshair", 6034328955)
...
local BlacklistTab = Window:CreateTab("Blacklist", 6031094678)
...
local StatsTab = Window:CreateTab("Stats", 6034287594)
