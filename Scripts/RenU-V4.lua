...
local HomeTab = Window:CreateTab("Home", 9080449299)
local MovementTab = Window:CreateTab("Movement", 6031260800)
local PlayersTab = Window:CreateTab("Players", 6022668898)
local VisualsTab = Window:CreateTab("Visuals", 6034316009)
local TargetingTab = Window:CreateTab("Targeting", 6031154871)
