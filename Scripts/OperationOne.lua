...
local AimbotToggleKeybind = RenLib:RegisterKeybind({
    Name = "Aimbot Toggle",
    Default = Config.QuickToggleKey.Name,
    Flag = "ArenaAimbotToggleKey",
    Mode = "Press",
})
...
CombatControls:CreateLabel("Aimbot shortcut is editable in the Keybind Manager.")
...
UserInputService.InputBegan:Connect(function(Input, GameProcessed)
    ...
    if Input.UserInputType == Enum.UserInputType.Keyboard
        and Input.KeyCode.Name == AimbotToggleKeybind:Get()
    then
