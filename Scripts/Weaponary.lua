...
local HotkeyLabel = MainControls:CreateLabel("Hotkey: Press X to toggle")
...
StatusLabel:SetText("Status: 🔴 Disabled - Press X to enable")
TargetLabel:SetText("Target: None")
HotkeyLabel:SetText("Hotkey: Press X to toggle instantly")
