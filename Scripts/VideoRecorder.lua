...
--// Rayfield UI + Freecam + Recording Mode + Physics Ghost + Smooth Keyframes + Curve Freecam
...
do
	...
	if not ok then
		warn("[Recorder V2] Rayfield failed to load:", result)
		return
	end
...
local Window = Rayfield:CreateWindow({
	...
	LoadingTitle = "Recorder Script V2",
	LoadingSubtitle = "Cinematic camera recorder",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = "RecorderScriptV2",
		FileName = "RecorderSettings"
	},
	Discord = {
		Enabled = false
	},
...
local GhostTab = Window:CreateTab("Physics Ghost", 4483362458)
local KeyframeTab = Window:CreateTab("Keyframes", 4483362458)
local CurveTab = Window:CreateTab("Curve Freecam", 4483362458)
local CleanupTab = Window:CreateTab("Cleanup", 4483362458)
...
MainTab:CreateSlider({
	...
	Increment = 1,
	Suffix = "stud/s",
	CurrentValue = Settings.FreecamSpeed,
...
MainTab:CreateSlider({
	...
	Increment = 1,
	Suffix = "",
	CurrentValue = Settings.FreecamSmoothness,
...
MainTab:CreateToggle({
	...
	CurrentValue = Settings.DesyncCharacterMovement,
...
MainTab:CreateToggle({
	...
	CurrentValue = Settings.HideCoreGui,
...
RecordingTab:CreateToggle({
	...
	CurrentValue = Settings.AutoHideGameUIWhenRecording,
...
KeyframeTab:CreateSlider({
	Name = "Playback Time Per Segment",
	Range = {0.25, 10},
	Increment = 0.25,
	Suffix = "s",
	CurrentValue = Settings.PlaybackSegmentTime,
...
KeyframeTab:CreateToggle({
	Name = "Continuous Smooth Path",
	CurrentValue = Settings.PlaybackSmoothPath,
...
KeyframeTab:CreateToggle({
	...
	CurrentValue = Settings.StopAtEachKeyframe,
...
KeyframeTab:CreateSlider({
	...
	Increment = 0.05,
	Suffix = "s",
	CurrentValue = Settings.KeyframePauseTime,
...
KeyframeTab:CreateToggle({
	Name = "Loop Playback",
	CurrentValue = Settings.PlaybackLoop,
...
CurveTab:CreateToggle({
	Name = "Enable Curve Freecam Stabilizer",
	CurrentValue = Settings.Curve.Enabled,
...
CurveTab:CreateToggle({
	...
	CurrentValue = Settings.Curve.LockAngle,
...
CurveTab:CreateToggle({
	...
	CurrentValue = Settings.Curve.SliderMode,
...
CurveTab:CreateSection("X Axis")

CurveTab:CreateToggle({
	Name = "Lock X",
	CurrentValue = Settings.Curve.LockX,
...
CurveTab:CreateSection("Y Axis / Height")

CurveTab:CreateToggle({
	Name = "Lock Y Height",
	CurrentValue = Settings.Curve.LockY,
...
CurveTab:CreateSection("Z Axis")

CurveTab:CreateToggle({
	Name = "Lock Z",
	CurrentValue = Settings.Curve.LockZ,
...
CurveTab:CreateSection("Presets")
