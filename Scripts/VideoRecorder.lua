...
do
	...
	RenLib = result
	Rayfield = RenLib:CreateRayfieldAdapter()
end
...
local RecordingTab = Window:CreateTab("Recording", 6026663699)
local GhostTab = Window:CreateTab("Physics Ghost", 6022668898)
local KeyframeTab = Window:CreateTab("Keyframes", 6034328955)
local CurveTab = Window:CreateTab("Curve Freecam", 6034925618)
local CleanupTab = Window:CreateTab("Cleanup", 6031094678)
